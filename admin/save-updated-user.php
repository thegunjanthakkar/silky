    ...
    try {
        ...
        <head>
            <style>
                ...
                .update-info { background-color: white; padding: 20px; border-radius: 8px; margin: 15px 0; border: 1px solid #e2e8f0; }
        ...
        <body>
            <div class="email-container">
                ...
                <div class="header">
                    <h1 style="margin: 0; font-size: 22px;">Account Update Notification</h1>
                </div>
                <div class="content">
