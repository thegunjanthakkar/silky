              ...
              <div class="container" data-aos="fade-up" data-aos-delay="100">
                ...
                <div class="row g-4">
                  ...
                  <div class="col-lg-3 col-md-6">
                    <div class="bs3d-card product-item" 
                      ...
                      <div class="bs3d-card-img">
                        ...
                        <?php elseif ($badge): ?>
                        <div class="bs3d-badge <?php echo $badgeClass; ?>"><?php echo $badge; ?></div>
                        <?php endif; ?>
                        ...
                        <div class="bs3d-overlay">
                          <div class="bs3d-overlay-actions">
                            ...
                            <a href="<?php echo $base_url; ?>product-details/<?php echo htmlspecialchars($product['slug'] ?? 'product-'.$product['id']); ?>" class="bs3d-action-btn" title="View Details">
                              <i class="bi bi-eye"></i>
                            </a>
                          </div>
                          <a href="<?php echo $base_url; ?>product-details/<?php echo htmlspecialchars($product['slug'] ?? 'product-'.$product['id']); ?>" class="bs3d-shop-btn custom-glass-btn" style="text-decoration: none;">SHOP NOW</a>
                        </div>
                      </div>
                      <div class="bs3d-card-info">
                        <span class="bs3d-category"><?php echo htmlspecialchars($product['category_name'] ?? 'Uncategorized'); ?></span>
                        <h4 class="bs3d-name"><?php echo htmlspecialchars($product['name']); ?></h4>
                        <div class="bs3d-stars">
                          <?php 
                          $rating = isset($product['avg_rating']) ? round($product['avg_rating'], 1) : 0;
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  function generateProductHTML(product) {
    ...
    let badgeHTML = '';
    if (product.badge) {
      badgeHTML = `<div class="bs3d-badge ${product.badge_class}">${product.badge}</div>`;
    }
    ...
    return `
      <div class="col-lg-3 col-md-6">
        <div class="bs3d-card product-item" 
          ...
          <div class="bs3d-card-img">
            <img src="${escapeHtml(product.image)}" alt="${escapeHtml(product.name)}" onerror="this.src='assets/img/product/saree1.png'">
            ${badgeHTML}
            ${videoHTML}
            <div class="bs3d-overlay">
              <div class="bs3d-overlay-actions">
                <button class="bs3d-action-btn wishlist-btn ${activeClass}" data-product-id="${product.id}" title="Wishlist">
                  <i class="bi ${heartIcon}"></i>
                </button>
                <button class="bs3d-action-btn add-to-cart" data-product-id="${product.id}" title="Add to Cart">
                  <i class="bi bi-cart-plus"></i>
                </button>
                <a href="<?php echo $base_url; ?>product-details/${product.slug}" class="bs3d-action-btn" title="View Details">
                  <i class="bi bi-eye"></i>
                </a>
              </div>
              <a href="<?php echo $base_url; ?>product-details/${product.slug}" class="bs3d-shop-btn custom-glass-btn" style="text-decoration: none;">SHOP NOW</a>
            </div>
          </div>
          <div class="bs3d-card-info">
            <span class="bs3d-category">${escapeHtml(product.category)}</span>
            <h4 class="bs3d-name">${escapeHtml(product.name)}</h4>
            <div class="bs3d-stars">
              ${generateStarsHTML(product.avg_rating)}
              <span>(${product.review_count || 0})</span>
            </div>
            <div class="bs3d-price">${product.price_formatted}</div>
            ${colorSwatchesHTML}
          </div>
        </div>
      </div>
